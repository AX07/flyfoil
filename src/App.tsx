...
import { 
  ...
  Gift, UserCheck, LifeBuoy, Sun, Moon
} from 'lucide-react';
...
export default function App() {
  ...
  const [selectedExperience, setSelectedExperience] = useState("Starter Flight (15 min) - €50");
    ...
    <div className="min-h-screen bg-navy text-white selection:bg-electric selection:text-navy">
          ...
          <div className="flex flex-col items-center justify-center cursor-pointer group" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <div className="relative flex flex-col items-center justify-center w-20 h-20 md:w-24 md:h-24 rounded-full border-[1.5px] border-[#D4AF37]/60 group-hover:border-[#D4AF37] transition-colors bg-navy/30 backdrop-blur-sm">
              ...
              <div className="flex flex-col items-center justify-center w-full h-full pt-1">
                ...
                <span className="text-[5px] md:text-[6px] tracking-[0.3em] text-[#D4AF37] uppercase leading-none font-medium ml-1">
                  RIA FORMOSA
                </span>
              </div>
            </div>
      ...
      <section className="relative min-h-[100svh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-navy/20 to-navy z-10"></div>
          <video 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full pt-32 pb-20 md:pt-24 md:pb-24 flex flex-col items-center text-center justify-center">
          ...
          >
            EFOIL OVER THE <span className="text-transparent bg-clip-text bg-gradient-to-r from-silver to-white">ALGARVE.</span>
          </motion.h1>
          ...
          <motion.p 
            ...
            className="text-base sm:text-lg md:text-xl text-silver/90 max-w-2xl mb-8 md:mb-12 font-light px-4"
          >
          ...
          >
            {[
              { 
                ...
                price: "€50", 
                desc: "15 min Instruction Session",
              ...
              <div 
                ...
                className="cursor-pointer relative p-2 sm:p-4 md:p-6 flex flex-col items-center text-center transition-transform hover:scale-105 group"
              >
                {plan.popular && <div className="absolute -top-4 md:-top-2 left-1/2 -translate-x-1/2 text-electric text-[8px] md:text-[10px] font-bold px-2 md:px-3 py-1 tracking-widest uppercase">MOST POPULAR</div>}
                <div className="transform group-hover:-translate-y-2 transition-transform duration-300 scale-75 sm:scale-100">
                  {plan.icon}
                </div>
                <h3 className="text-silver font-medium text-[10px] sm:text-sm mb-0.5 md:mb-1 uppercase tracking-wider">{plan.title}</h3>
                <div className="text-xl sm:text-3xl font-bold text-white mb-0.5 md:mb-1">{plan.price}</div>
                <p className="text-[8px] sm:text-xs text-silver/60 uppercase tracking-widest hidden sm:block">{plan.desc}</p>
              </div>
            ))}
          </motion.div>
          ...
          <motion.button 
            ...
            className="px-6 py-3 md:px-8 md:py-4 bg-transparent border-2 border-white text-white font-bold rounded-full text-sm md:text-lg hover:bg-white hover:text-navy transition-all duration-300 flex items-center gap-2 group"
          >
      ...
      <section id="experience" className="relative py-24 flex items-center justify-center overflow-hidden min-h-[100svh]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-bold mb-4 tracking-tighter uppercase text-white">
              THE <span className="text-transparent bg-clip-text bg-gradient-to-r from-silver to-white">EXPERIENCE</span>
            </h2>
              ...
              >
                {[
                  ...
                  <div key={idx} className="w-full shrink-0 p-8 flex flex-col items-center text-center">
                    {feature.icon}
                    <h3 className="text-sm font-bold text-white mb-3 tracking-wider">{feature.title}</h3>
          ...
          <div className="hidden md:grid grid-cols-2 lg:grid-cols-4 gap-4 mb-24">
            {[
              ...
              <motion.div 
                ...
                className={`group p-8 rounded-2xl flex flex-col items-center text-center backdrop-blur-md ${idx % 2 === 0 ? 'bg-gradient-to-b from-navy/60 to-navy/20 border border-white/10' : 'bg-navy/40 border border-white/10'}`}
              >
                {feature.icon}
                <h3 className="text-sm font-bold text-white mb-3 tracking-wider">{feature.title}</h3>
                <p className="text-silver/80 text-sm leading-relaxed">{feature.desc}</p>
          ...
          <div className="flex flex-col gap-16">
            {[
              { id: "starter-flight", icon: <GraduationCap size={40} strokeWidth={1} />, title: "Starter Flight", desc: "Learn the basics: how to handle the e-foil, balance, and get on the board safely. Perfect for absolute beginners.", duration: "15 min", price: "€50", videoId: "5rR4XPne7MU" },
              ...
              <motion.div 
                ...
                className="flex flex-col gap-8 group scroll-mt-24 bg-navy/40 backdrop-blur-xl border border-white/10 p-6 md:p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden"
              >
                ...
                <div className="flex flex-col md:flex-row gap-8 items-start md:items-center justify-between">
                  <div className="flex-1 space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <h3 className="text-3xl md:text-4xl font-bold tracking-tighter">{feature.title}</h3>
                    </div>
                  ...
                  <div className="flex flex-col gap-6 w-full md:w-auto shrink-0">
                    ...
                    <button onClick={() => {
                      ...
                      scrollTo('locations');
                    }} className="px-8 py-4 bg-transparent border-2 border-white text-white text-sm font-bold tracking-widest uppercase rounded-full hover:bg-white hover:text-navy transition-all duration-300 text-center">
                      Book this flight
                    </button>
                  </div>
                </div>
      ...
      <section id="locations" className="py-24 bg-navy-light relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <div>
              <h2 className="text-3xl md:text-5xl font-bold mb-4">Choose Your Flight Zone</h2>
      ...
      <section className="py-24 bg-navy overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 mb-12 text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">Rider Stories</h2>
          ...
          {reviews.map((review, i) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-silver/90 italic mb-6 leading-relaxed">"{review.text}"</p>
                <div className="flex items-center gap-4">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 w-full">
          ...
          >
            ...
            <div className="text-center mb-10">
              <h2 className="text-4xl md:text-5xl font-bold mb-4 tracking-tighter uppercase text-white">
                SECURE YOUR <span className="text-transparent bg-clip-text bg-gradient-to-r from-silver to-white">SESSION</span>
              </h2>
              <p className="text-silver/90 text-lg font-light">Select your date, time, and preferred payment method.</p>
            </div>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input type="date" className="w-full bg-white/5 border border-white/10 rounded-xl py-4 pl-12 pr-4 text-white focus:outline-none focus:border-electric transition-colors appearance-none" />
                  </div>
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  >
                    <option>Starter Flight (15 min) - €50</option>
              ...
              <div className="pt-6 border-t border-white/10">
                <label className="text-sm text-silver font-medium block mb-4">Payment Method</label>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <label className="relative flex items-center p-4 cursor-pointer rounded-xl border border-white/10 bg-white/5 hover:border-electric/50 transition-colors">
                    <input type="radio" name="payment" className="peer sr-only" defaultChecked />
                    <div className="w-5 h-5 rounded-full border border-silver/50 peer-checked:border-electric peer-checked:border-[6px] mr-4 transition-all"></div>
                    <CreditCard className="text-silver mr-3" size={24} />
                    <span className="font-medium">Credit Card</span>
                  </label>
                  
                  <label className="relative flex items-center p-4 cursor-pointer rounded-xl border border-white/10 bg-white/5 hover:border-electric/50 transition-colors overflow-hidden">
                    <input type="radio" name="payment" className="peer sr-only" />
                    <div className="w-5 h-5 rounded-full border border-silver/50 peer-checked:border-electric peer-checked:border-[6px] mr-4 transition-all"></div>
                    <Bitcoin className="text-silver mr-3" size={24} />
                    <span className="font-medium">Crypto</span>
                    <div className="absolute right-0 top-0 bottom-0 bg-electric/10 text-electric text-[10px] font-bold px-3 flex items-center border-l border-electric/20">
                      5% OFF
                    </div>
                  </label>
                </div>
              ...
              <button type="submit" className="w-full py-4 bg-transparent border-2 border-white text-white font-bold rounded-full text-lg hover:bg-white hover:text-navy transition-all duration-300">
                CONFIRM BOOKING
              </button>
            </form>
          </motion.div>
      ...
      <footer className="bg-navy pt-20 pb-10 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
              ...
              <div className="flex flex-col items-start mb-6">
                <div className="relative flex flex-col items-center justify-center w-28 h-28 rounded-full border-[1.5px] border-[#D4AF37]/60 mb-6">
                  ...
                  <div className="flex flex-col items-center justify-center w-full h-full pt-1">
                    ...
                    <span className="text-[6px] tracking-[0.3em] text-[#D4AF37] uppercase leading-none font-medium ml-1">
                      RIA FORMOSA
                    </span>
                  </div>
                </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-silver/70">
                ...
                <li><a href="mailto:hello@flyfoil.com" className="hover:text-electric transition-colors">hello@flyfoil.com</a></li>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-silver/50">
            <p>&copy; {new Date().getFullYear()} FLYFOIL.COM. All rights reserved.</p>
      ...
      <a 
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] text-[#ffffff] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
